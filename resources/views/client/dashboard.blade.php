            ...
            <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active"
                        style="background: url(data/jumbotron/{{ $jumbotron[0]->foto }});">
                        <div class="carousel-background"><img src="{{ url('data/jumbotron/' . $jumbotron[0]->foto) }}"
                    ...
                    <div class="carousel-item" style="background: url(data/jumbotron/{{ $jumbotron[1]->foto }});">
                        <div class="carousel-background"><img src="{{ url('data/jumbotron/' . $jumbotron[1]->foto) }}"
                                style="width:100%" alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                @php
                                ...
                                <div>
                                    <a href="{{ $jumbotron[1]->link1 }}"
                                        class="btn-menu animate__animated animate__fadeInUp scrollto">Layanan Kami</a>
                                    <a href="{{ $jumbotron[1]->link2 }}"
                                        class="btn-book animate__animated animate__fadeInUp scrollto">Lakukan
                                        Pemesanan</a>
                                </div>
                            </div>
                    ...
                    <div class="carousel-item" style="background: url(data/jumbotron/{{ $jumbotron[2]->foto }});">
                        <div class="carousel-background"><img src="{{ url('data/jumbotron/' . $jumbotron[2]->foto) }}"
                                style="width:100%" alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
                                @php
                                ...
                                <div>
                                    <a href="{{ $jumbotron[2]->link1 }}"
                                        class="btn-menu animate__animated animate__fadeInUp scrollto">Layanan Kami</a>
                                    <a href="{{ $jumbotron[2]->link2 }}"
                                        class="btn-book animate__animated animate__fadeInUp scrollto">Lakukan
                                        Pemesanan</a>
                                </div>
                            </div>
                            ...
                            <div class="gallery-item">
                                @if ($galeri->tipe == 1)
                                    <a href="{{ url('data/galeri/' . $galeri->foto) }}" data-gall="gallery-item">
                                        <img src="{{ url('data/galeri/' . $galeri->foto) }}" alt="">
                                    </a>
                                @endif
                                @if ($galeri->tipe == 2)
                                    <a href="#" class="venobox" data-gall="gallery-item">
                                        <iframe width="325px" height="270px" src="{{ $galeri->foto }}" frameborder="0"
