...
<main>
                                    ...
                                    <div id="dotStep1">
                                        ...
                                        <form method="POST" action="{{ url('jumbotron/kata-1') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="hidden" class="form-control" id="id1" name="id1" value="{{ $data2[0]->id_jumbotron }}">
                                                <input type="text" class="form-control" id="judul1" name="judul1" value="{{ $data2[0]->judul }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Kata</label>
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" id="kata1" name="kata1" value="{{ $data2[0]->kata }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Background</label>
                                                <div class="col-sm-10">
                                                <img src="{{ url('data/jumbotron/'.$data2[0]->foto) }}" style="width:900px">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-0">
                                                <div class="col-sm-10">
                                                    <button type="submit" class="btn btn-primary mb-0" onclick="return confirm('Anda yakin?')">Ganti</button>
                                    ...
                                    <div id="dotStep2">
                                        ...
                                        <form method="POST" action="{{ url('jumbotron/kata-2') }}">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Judul</label>
                                                <div class="col-sm-10">
                                                    <input type="hidden" class="form-control" id="id2" name="id2" value="{{ $data2[1]->id_jumbotron }}">
                                                    <input type="text" class="form-control" id="judul2" name="judul2" value="{{ $data2[1]->judul }}" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Kata</label>
                                                    <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="kata2" name="kata2" value="{{ $data2[1]->kata }}" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Background</label>
                                                    <div class="col-sm-10">
                                                    <img src="{{ url('data/jumbotron/'.$data2[1]->foto) }}" style="width:900px">
                                                    </div>
                                                </div>
                                            <div class="form-group row mb-0">
                                                <div class="col-sm-10">
                                    ...
                                    <div id="dotStep3">
                                        ...
                                        <form method="POST" action="{{ url('jumbotron/kata-3') }}">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Judul</label>
                                                <div class="col-sm-10">
                                                    <input type="hidden" class="form-control" id="id3" name="id3" value="{{ $data2[2]->id_jumbotron }}">
                                                    <input type="text" class="form-control" id="judul3" name="judul3" value="{{ $data2[2]->judul }}" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Kata</label>
                                                    <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="kata3" name="kata3" value="{{ $data2[2]->kata }}" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Background</label>
                                                    <div class="col-sm-10">
                                                    <img src="{{ url('data/jumbotron/'.$data2[2]->foto) }}" style="width:900px">
                                                    </div>
                                                </div>
                                            <div class="form-group row mb-0">
                                                <div class="col-sm-10">
    ...
    <div class="modal fade modal-right" id="gambar1" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ url('jumbotron/gambar-1') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>Foto</label>
                                                <input type="hidden" class="form-control" id="id1" name="id1" value="{{ $data2[0]->id_jumbotron }}">
                                                <input type="hidden" class="form-control" id="lama1" name="lama1" value="{{ $data2[0]->foto }}">
            ...
            <div class="modal fade modal-right" id="gambar2" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalRight" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ url('jumbotron/gambar-2') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>Foto</label>
                                                <input type="hidden" class="form-control" id="id2" name="id2" value="{{ $data2[1]->id_jumbotron }}">
                                                <input type="hidden" class="form-control" id="lama2" name="lama2" value="{{ $data2[1]->foto }}">
            ...
            <div class="modal fade modal-right" id="gambar3" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalRight" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ url('jumbotron/gambar-3') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>Foto</label>
                                                <input type="hidden" class="form-control" id="id3" name="id3" value="{{ $data2[2]->id_jumbotron }}">
                                                <input type="hidden" class="form-control" id="lama3" name="lama3" value="{{ $data2[2]->foto }}">
