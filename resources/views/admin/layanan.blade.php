...
@section('content')
    <main>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 250px">
                                        <a class="btn btn-outline-info mb-1" data-toggle="modal" data-backdrop="static"
                                            data-target="#update{{ $data->id_layanan }}">
                                            Edit
                                        </a>
                                        <a class="btn btn-outline-info mb-1"
                                            href="{{ url('layanan/delete/' . $data->id_layanan) }}"
        ...
        @foreach ($data2 as $u):
            <div class="modal fade modal-right" id="update{{ $u->id_layanan }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ url('layanan/update') }}">
                                ...
                                <div class="form-group">
                                    <label>Nama Layanan</label>
                                    <input type="hidden" id="id" name="id" class="form-control" value="{{ $u->id_layanan }}"
                                        required>
                                    <input type="text" id="nama_layanan" name="nama_layanan" class="form-control"
                                        value="{{ $u->nama_layanan }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Keterangan</label>
                                    <input type="text" id="keterangan" name="keterangan" class="form-control"
                                        value="{{ $u->keterangan }}" required>
                                </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
